...
Sub usage 
	Puts "usage:"
	Puts ""
	Puts "$ namgen.exe in=screen.png out=file.nam pals=pals.png chr=tileset.chr [bank=B] [rle]"
	Puts ""
	...
	Puts "rle            output is code in .h with rle'd screen"
End Sub
...
Sub writeRledOutput (fn As String)
	...
	Print #fOut, "// RLE'd nametable by namgen v0.3 20181107"
	Print #fOut, ""
